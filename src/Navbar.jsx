import {Box,Img,Input,Flex,Button,Modal,ModalOverlay,ModalContent,ModalHeader,Text,Divider} from "@chakra-ui/react"
    ...
    return(
        ...
        <Box h="40px" p="7px 25px" bg="white" >
            <Flex>
                ...
                <Box w="40%" h="40px" >
                    <Button mb="40px" bg="white" p="0" w="20%" border="none"><Img src={truck} alt="truck" w="50%" pl="20px" pt="3px"/></Button>
                    <Button mb="40px" bg="white" p="0" w="20%" border="none"><Img src={favorite} alt="favorite" w="50%" pl="15px" pt="3px"/></Button>
                    <Button mb="40px" bg="white" p="0" w="20%" border="none"><Img src={message} alt="message" w="40%" pl="15px" pt="3px"/></Button>
                    <Button mb="40px" bg="white" p="0" w="20%" border="none"><Img src={notification} alt="notification" w="40%" pl="15px" pt="3px"/></Button>
                    <Button mb="40px" bg="white" p="0" w="20%" border="none"><Img src={cart} alt="cart" w="40%" pl="15px" pt="3px"/></Button>
                </Box>
                <Box w="20%" h="40px">
        ...
        <Box  h="40px" bg="white" >
            ...
            <Button w="12%" border="none" bg="white" p="3"><Img src={badge} alt="badge" w="10%" p="10px"/>Lowest price gurantee</Button>
